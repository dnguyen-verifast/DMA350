//==============================================================================
// dma350_vseq_trig_srcflow_single.sv
...
//==============================================================================
`ifndef DMA350_VSEQ_TRIG_SRCFLOW_SINGLE_SV
`define DMA350_VSEQ_TRIG_SRCFLOW_SINGLE_SV

class dma350_vseq_trig_srcflow_single extends dma350_vseq_trig_base;
  `uvm_object_utils(dma350_vseq_trig_srcflow_single)

  function new(string name = "dma350_vseq_trig_srcflow_single");
    super.new(name);
    ch          = 0;
    xsize       = 16;
    use_srctrig = 1;
...
endclass : dma350_vseq_trig_srcflow_single

`endif // DMA350_VSEQ_TRIG_SRCFLOW_SINGLE_SV
