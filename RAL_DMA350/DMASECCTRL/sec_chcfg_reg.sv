// SEC_CHCFG - Offset 0x18 - RW - reset 0x00000000
// Secure Channel Configuration (privilege + channel ID) for channel in SEC_CHPTR.
class sec_chcfg_reg extends uvm_reg;
    rand uvm_reg_field CHPRIV;
    rand uvm_reg_field CHIDVLD;
    rand uvm_reg_field CHID;

    `uvm_object_utils(sec_chcfg_reg)
    function new(string name = "sec_chcfg_reg");
