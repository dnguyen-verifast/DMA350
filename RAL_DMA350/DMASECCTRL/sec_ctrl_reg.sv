// SEC_CTRL - Offset 0x0C - RW - reset 0x00000000
// Secure control: power/debug-halt/all-channel requests + interrupt enables.
// NOTE: unlike NSEC_CTRL, here DBGHALTNSRO is RW (Secure SW can lock the common DBGHALTEN).
class sec_ctrl_reg extends uvm_reg;
    ...
    `uvm_object_utils(sec_ctrl_reg)
    function new(string name = "sec_ctrl_reg");
    ...
    virtual function void build();
        ...
        this.DBGHALTNSRO.configure(        this,1,27,"RW", 0,1'h0,1,0,0);
