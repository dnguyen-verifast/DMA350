// AIDR - Offset 0xCC - RO - reset IMPLEMENTATION DEFINED
// DMA unit Architecture Identification register.
class aidr_reg extends uvm_reg;
    rand uvm_reg_field ARCH_MAJOR_REV;
    rand uvm_reg_field ARCH_MINOR_REV;

    `uvm_object_utils(aidr_reg)
    function new(string name = "aidr_reg");
