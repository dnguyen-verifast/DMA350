// CH_IIDR - Offset 0xC8 - RO - reset IMPLEMENTATION DEFINED
// Channel Implementation Identification register.
class ch_iidr_reg extends uvm_reg;
    rand uvm_reg_field PRODUCTID;
    rand uvm_reg_field VARIANT;
    rand uvm_reg_field REVISION;
    rand uvm_reg_field IMPLEMENTER;

    `uvm_object_utils(ch_iidr_reg)
    function new(string name = "ch_iidr_reg");
