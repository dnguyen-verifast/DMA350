// NSEC_STATUS - Offset 0x08 - RW - reset 0x00000000
// Non-secure overall channel status + interrupt status.
class nsec_status_reg extends uvm_reg;
    ...
    `uvm_object_utils(nsec_status_reg)
    function new(string name = "nsec_status_reg");
