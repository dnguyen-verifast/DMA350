class apb_seq_master_strb_random extends apb_seq_base_master;
    `uvm_object_utils(apb_seq_master_strb_random)

    function new(string name ="apb_seq_master_strb_random");
        super.new(name);
    endfunction
