class apb_seq_master_out_of_range extends apb_seq_base_master;
    `uvm_object_utils(apb_seq_master_out_of_range)

    function new(string name ="apb_seq_master_out_of_range");
        super.new(name);
    endfunction
    ...
    virtual task body();
		...
		repeat(2) begin
        	...
        	start_item(item_seq_m);
       		assert(item_seq_m.randomize() with {pwrite == 1'b1; paddr > 32'h10000;});
