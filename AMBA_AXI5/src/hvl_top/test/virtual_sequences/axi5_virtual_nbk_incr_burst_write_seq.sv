`ifndef AXI5_VIRTUAL_NBK_INCR_BURST_WRITE_SEQ_INCLUDED_
`define AXI5_VIRTUAL_NBK_INCR_BURST_WRITE_SEQ_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: axi5_virtual_nbk_incr_burst_write_seq
// Creates and starts the master and slave sequences
//--------------------------------------------------------------------------------------------
class axi5_virtual_nbk_incr_burst_write_seq extends axi5_virtual_base_seq;
  `uvm_object_utils(axi5_virtual_nbk_incr_burst_write_seq)
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi5_virtual_nbk_incr_burst_write_seq");
  extern task body();
endclass : axi5_virtual_nbk_incr_burst_write_seq
...
//
// Parameters:
//  name - axi5_virtual_nbk_incr_burst_write_seq
//--------------------------------------------------------------------------------------------
function axi5_virtual_nbk_incr_burst_write_seq::new(string name = "axi5_virtual_nbk_incr_burst_write_seq");
  super.new(name);
endfunction : new
...
//--------------------------------------------------------------------------------------------
task axi5_virtual_nbk_incr_burst_write_seq::body();
  ...
  `uvm_info(get_type_name(), $sformatf("DEBUG_MSHA :: Insdie axi5_virtual_nbk_incr_burst_write_seq"), UVM_NONE); 
