`ifndef AXI5_MASTER_DRIVER_PROXY_INCLUDED_
`define AXI5_MASTER_DRIVER_PROXY_INCLUDED_
...
//--------------------------------------------------------------------------------------------
class axi5_master_driver_proxy extends uvm_driver#(axi5_master_tx);
  `uvm_component_utils(axi5_master_driver_proxy)
  ...
  //Variable: axi5_master_write_fifo_h
  //Declaring handle for uvm_tlm_analysis_fifo for write task
  uvm_tlm_analysis_fifo #(axi5_master_tx) axi5_master_write_fifo_h;
  ...
  //Variable: axi5_master_drv_bfm_h
  //Declaring handle for axi5 driver bfm
  virtual axi5_master_driver_bfm axi5_master_drv_bfm_h;
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi5_master_driver_proxy", uvm_component parent = null);
...
endclass : axi5_master_driver_proxy

//--------------------------------------------------------------------------------------------
// Construct: new
//
// Parameters:
//  name - axi5_master_driver_proxy
//  parent - parent under which this component is created
//--------------------------------------------------------------------------------------------
function axi5_master_driver_proxy::new(string name = "axi5_master_driver_proxy", uvm_component parent = null);
  super.new(name, parent);
  axi_write_seq_item_port    = new("axi_write_seq_item_port",this);
  axi_read_seq_item_port     = new("axi_read_seq_item_port",this);
  axi_write_rsp_port         = new("axi_write_rsp_port",this);
  axi_read_rsp_port          = new("axi_read_rsp_port",this);
  axi5_master_write_fifo_h   = new("axi5_master_write_fifo_h",this);
...
//  phase - uvm phase
//--------------------------------------------------------------------------------------------
function void axi5_master_driver_proxy::build_phase(uvm_phase phase);
  super.build_phase(phase);
  if(!uvm_config_db #(virtual axi5_master_driver_bfm)::get(this,"","axi5_master_driver_bfm",axi5_master_drv_bfm_h)) begin
    `uvm_fatal("FATAL_MDP_CANNOT_GET_AXI5_MASTER_DRIVER_BFM","cannot get() axi5_master_drv_bfm_h");
  end
...
//  phase - uvm phase
//--------------------------------------------------------------------------------------------
function void axi5_master_driver_proxy::end_of_elaboration_phase(uvm_phase phase);
  super.end_of_elaboration_phase(phase);
  axi5_master_drv_bfm_h.axi5_master_drv_proxy_h = this;
...
//  phase - uvm phase
//--------------------------------------------------------------------------------------------
task axi5_master_driver_proxy::run_phase(uvm_phase phase);

  //waiting for system reset
  axi5_master_drv_bfm_h.wait_for_aresetn();
...
//--------------------------------------------------------------------------------------------
// Task: axi5_write_task
//  Gets the sequence_item, converts them to struct compatible transactions
//  and sends them to the BFM to drive the data over the interface
//--------------------------------------------------------------------------------------------
task axi5_master_driver_proxy::axi5_write_task();

  forever begin
    axi5_master_tx             local_master_tx;
    ...
    if(!axi5_master_write_fifo_h.is_full()) begin
      axi5_master_write_fifo_h.put(req_wr);
			axi5_master_write_data_fifo_h.put(req_wr);
    end
    else begin
    ...
    if(req_wr.transfer_type == BLOCKING_WRITE) begin
      ...
      axi5_master_tx local_master_write_tx; 
      axi5_master_seq_item_converter::from_write_class(req_wr,struct_write_packet);
      `uvm_info(get_type_name(),$sformatf("WRITE_TASK::Checking transfer type = %s",req_wr.transfer_type),UVM_MEDIUM); 
      
      //Calling 3 write tasks from axi5_master_drv_bfm in HDL side
      axi5_master_drv_bfm_h.axi5_write_address_channel_task(struct_write_packet,struct_cfg);
      axi5_master_drv_bfm_h.axi5_write_data_channel_task(struct_write_packet,struct_cfg);
      axi5_master_drv_bfm_h.axi5_write_response_channel_task(struct_write_packet,struct_cfg);
			
      //Converts the struct packet to req packet
      axi5_master_seq_item_converter::to_write_class(struct_write_packet,local_master_write_tx);
      `uvm_info(get_type_name(),$sformatf("WRITE_TASK::Response Received_req_write_packet = \n %s",
                                           local_master_write_tx.sprint()),UVM_MEDIUM);
			axi5_master_write_fifo_h.get(local_master_write_tx); // !!!!
    end
    ...
    //Checking if the tranfer type is non blocking write 
      ...
      fork
        begin : WRITE_ADDRESS_CHANNEL 
          axi5_master_tx             local_master_addr_tx;
          axi5_write_transfer_char_s struct_write_addr_packet;
          ...
          axi5_master_seq_item_converter::from_write_class(req_wr,struct_write_addr_packet);
          ...
          axi5_master_drv_bfm_h.axi5_write_address_channel_task(struct_write_addr_packet,struct_cfg);

          //Converting the write data struct packet to req packet
          axi5_master_seq_item_converter::to_write_class(struct_write_addr_packet,req_wr);
          ...
          `uvm_info(get_type_name(),$sformatf("WRITE_ADDRESS_THREAD::Checking fifo size used= %0d",
                                               axi5_master_write_fifo_h.used()),UVM_FULL);
        end
    
        begin : WRITE_DATA_CHANNEL
          axi5_master_tx             local_master_data_tx;
          axi5_write_transfer_char_s struct_write_data_packet;
          ...
          `uvm_info(get_type_name(),$sformatf("WRITE_DATA_THREAD::Checking fifo size = %0d",
                                               axi5_master_write_fifo_h.size()),UVM_FULL); 
          ...
          if(!axi5_master_write_data_fifo_h.is_empty()) begin
            axi5_master_write_data_fifo_h.get(local_master_data_tx);
          end
          else begin
          ...
          axi5_master_seq_item_converter::from_write_class(local_master_data_tx,struct_write_data_packet);
          ...
          axi5_master_drv_bfm_h.axi5_write_data_channel_task(struct_write_data_packet,struct_cfg);
         
          //Converting the write data struct packet to req packet
          axi5_master_seq_item_converter::to_write_class(struct_write_data_packet,local_master_data_tx);
        ...
        begin : WRITE_RESPONSE_CHANNEL
          ...
          axi5_master_tx             local_master_response_tx;
          axi5_write_transfer_char_s struct_write_response_packet;
          ...
          if(!axi5_master_write_fifo_h.is_empty()) begin
            axi5_master_write_fifo_h.get(local_master_response_tx);
          end
          else begin
          ...
          //Converts the received req_packet to struct packet
          axi5_master_seq_item_converter::from_write_class(local_master_response_tx,struct_write_response_packet);
          ...
          axi5_master_drv_bfm_h.axi5_write_response_channel_task(struct_write_response_packet,struct_cfg);
          `uvm_info(get_type_name(),$sformatf("WRITE_RESPONSE_THREAD::Received_struct_packet = %p",
                                               struct_write_response_packet),UVM_FULL);

          //Converting the write data struct packet to req packet
          axi5_master_seq_item_converter::to_write_class(struct_write_response_packet,local_master_response_tx);
...
//  and sends them to the BFM to drive the data over the interface
//--------------------------------------------------------------------------------------------
task axi5_master_driver_proxy::axi5_read_task();
  forever begin
    
    //axi5_master_tx local_master_read_tx;
    ...
    //Return the fifo size that it is capable to hold
    //A return value of 0 indicates the FIFO capacity has no limit
    `uvm_info(get_type_name(),$sformatf("READ_TASK::Checking fifo size = %0d",axi5_master_write_fifo_h.size()),UVM_FULL); 
    ...
    if(!axi5_master_read_fifo_h.is_full()) begin
    ...
    if(req_rd.transfer_type == BLOCKING_READ) begin
      ...
      axi5_master_seq_item_converter::from_read_class(req_rd,struct_read_packet);
      ...
      axi5_master_drv_bfm_h.axi5_read_address_channel_task(struct_read_packet,struct_cfg);
      axi5_master_drv_bfm_h.axi5_read_data_channel_task(struct_read_packet,struct_cfg);
      ...
      axi5_master_read_fifo_h.get(req_rd);
    end
      ...
      fork
        begin : READ_ADDRESS_CHANNEL  
          axi5_read_transfer_char_s struct_read_address_packet;
          ...
          axi5_master_seq_item_converter::from_read_class(req_rd,struct_read_address_packet);
          ...
          axi5_master_drv_bfm_h.axi5_read_address_channel_task(struct_read_address_packet,struct_cfg);
        ...
        begin : READ_DATA_CHANNEL
          axi5_master_tx local_master_read_data_tx;
          axi5_read_transfer_char_s struct_read_data_packet;
          ...
          //Get method gets the packet and discards the packet from fifo
          //It throws an error if get is done into an empty fifo
          if(!axi5_master_read_fifo_h.is_empty()) begin
            axi5_master_read_fifo_h.get(local_master_read_data_tx);
          end
          else begin
          ...
          axi5_master_seq_item_converter::from_read_class(local_master_read_data_tx,struct_read_data_packet);
          ...
          axi5_master_drv_bfm_h.axi5_read_data_channel_task(struct_read_data_packet,struct_cfg);
          ...
          //Converting transactions into struct data type
          axi5_master_seq_item_converter::to_read_class(struct_read_data_packet,req_rd);
