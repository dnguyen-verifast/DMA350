`ifndef AXI5_MASTER_COVERAGE_INCLUDED_
`define AXI5_MASTER_COVERAGE_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: master_coverage
// master_coverage determines the how much code is covered for better functionality of the TB.
//--------------------------------------------------------------------------------------------
class axi5_master_coverage extends uvm_subscriber #(axi5_master_tx);
  `uvm_component_utils(axi5_master_coverage)
  ...
  //-------------------------------------------------------
  // Covergroup: axi5_master_covergroup
  // Covergroup consists of the various coverpoints based on
  // no. of the variables used to improve the coverage.
  //-------------------------------------------------------
  covergroup axi5_master_covergroup with function sample (axi5_master_agent_config cfg, axi5_master_tx packet);
  ...
  endgroup: axi5_master_covergroup


  //-------------------------------------------------------
  // Externally defined Tasks and Functions
  //-------------------------------------------------------
  extern function new(string name = "axi5_master_coverage", uvm_component parent = null);
  extern virtual function void write(axi5_master_tx t);
  extern virtual function void report_phase(uvm_phase phase);

endclass : axi5_master_coverage

//--------------------------------------------------------------------------------------------
// Construct: new
//
// Parameters:
//  name - axi5_master_coverage
//  parent - parent under which this component is created
//--------------------------------------------------------------------------------------------
function axi5_master_coverage::new(string name = "axi5_master_coverage",
                                 uvm_component parent = null);
  super.new(name, parent);
  axi5_master_covergroup =new();
endfunction : new
...
// sampling is done
//--------------------------------------------------------------------------------------------
function void axi5_master_coverage::write(axi5_master_tx t);
 `uvm_info(get_type_name(),$sformatf("Before calling SAMPLE METHOD"),UVM_HIGH);

  axi5_master_covergroup.sample(axi5_master_agent_cfg_h,t);
...
//--------------------------------------------------------------------------------------------
function void axi5_master_coverage::report_phase(uvm_phase phase);
  `uvm_info(get_type_name(),$sformatf("AXI5 Master Agent Coverage = %0.2f %%", axi5_master_covergroup.get_coverage()), UVM_NONE);
