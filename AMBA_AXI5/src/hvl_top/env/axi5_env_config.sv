`ifndef AXI5_ENV_CONFIG_INCLUDED_
`define AXI5_ENV_CONFIG_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: axi5 env_config
...
class axi5_env_config extends uvm_object;
  ...
  // Handle for axi5 master agent configuration
  axi5_master_agent_config axi5_master_agent_cfg_h[];

  // Variable: slave_agent_cfg_h
  // axi5 slave agent configuration handles
  axi5_slave_agent_config axi5_slave_agent_cfg_h[];

//-------------------------------------------------------
// Externally defined Tasks and Functions
//-------------------------------------------------------
  extern function new(string name = "axi5_env_config");
  extern function void do_print(uvm_printer printer);

endclass : axi5_env_config

//--------------------------------------------------------------------------------------------
// Construct: new
//
// Parameters:
//  name - axi5_env_config
//--------------------------------------------------------------------------------------------
function axi5_env_config::new(string name = "axi5_env_config");
  super.new(name);
endfunction : new
...
//--------------------------------------------------------------------------------------------
function void axi5_env_config::do_print(uvm_printer printer);
