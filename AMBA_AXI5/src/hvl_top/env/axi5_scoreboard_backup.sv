...
class axi5_scoreboard extends uvm_scoreboard;
  ...
  extern virtual task axi5_write_address_comparision(input axi5_master_tx axi5_master_tx_h1,input axi5_slave_tx axi5_slave_tx_h1);
  extern virtual task axi5_write_data_comparision(input axi5_master_tx axi5_master_tx_h2,input axi5_slave_tx axi5_slave_tx_h2);
  extern virtual task axi5_write_response_comparision(input axi5_master_tx axi5_master_tx_h3,input axi5_slave_tx axi5_slave_tx_h3);
  extern virtual task axi5_read_address_comparision(input axi5_master_tx axi5_master_tx_h4,input axi5_slave_tx axi5_slave_tx_h4);
  extern virtual task axi5_read_data_comparision(input axi5_master_tx axi5_master_tx_h5,input axi5_slave_tx axi5_slave_tx_h5);
...
task axi5_scoreboard::axi5_write_data();
  ...
  forever begin
    ...
    axi5_write_data_comparision(axi5_master_tx_h2,axi5_slave_tx_h2);
...
task axi5_scoreboard::axi5_write_response();
  ...
  forever begin
    ...
    axi5_write_response_comparision(axi5_master_tx_h3,axi5_slave_tx_h3);
...
task axi5_scoreboard::axi5_read_address();
  ...
  forever begin
    ...
    axi5_read_address_comparision(axi5_master_tx_h4,axi5_slave_tx_h4);
...
task axi5_scoreboard::axi5_read_data();
  ...
  forever begin
    ...
    axi5_read_data_comparision(axi5_master_tx_h5,axi5_slave_tx_h5);
...
//--------------------------------------------------------------------------------------------
// Task : axi5_write_address_comparision
// Used to compare the received master and slave write address
// Parameter :
//  axi5_master_tx_h1 - axi5_master_tx
//  axi5_slave_tx_h1  - axi5_slave_tx
//--------------------------------------------------------------------------------------------
task axi5_scoreboard::axi5_write_address_comparision(input axi5_master_tx axi5_master_tx_h1,input axi5_slave_tx axi5_slave_tx_h1);

  if(axi5_master_tx_h1.awid == axi5_slave_tx_h1.awid)begin
    `uvm_info(get_type_name(),$sformatf("axi5_awid from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_AWID_MATCHED", $sformatf("Master AWID = 'h%0x and Slave AWID = 'h%0x",axi5_master_tx_h1.awid,axi5_slave_tx_h1.awid), UVM_HIGH);             
    byte_data_cmp_verified_awid_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_awid from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_AWID_NOT_MATCHED", $sformatf("Master AWID = 'h%0x and Slave AWID = 'h%0x",axi5_master_tx_h1.awid,axi5_slave_tx_h1.awid), UVM_HIGH);             
    byte_data_cmp_failed_awid_count++;
  end
  
  if(axi5_master_tx_h1.awaddr == axi5_slave_tx_h1.awaddr)begin
    `uvm_info(get_type_name(),$sformatf("axi5_awaddr from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_AWADDR_MATCHED", $sformatf("Master AWADDR = 'h%0x and Slave AWADDR = 'h%0x",axi5_master_tx_h1.awaddr,axi5_slave_tx_h1.awaddr), UVM_HIGH);             
    byte_data_cmp_verified_awaddr_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_awaddr from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_AWADDR_NOT_MATCHED", $sformatf("Master AWADDR = 'h%0x and Slave AWADDR = 'h%0x",axi5_master_tx_h1.awaddr,axi5_slave_tx_h1.awaddr), UVM_HIGH);             
    byte_data_cmp_failed_awaddr_count++;
  end

  if(axi5_master_tx_h1.awlen == axi5_slave_tx_h1.awlen)begin
    `uvm_info(get_type_name(),$sformatf("axi5_awlen from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_awlen_MATCHED", $sformatf("Master awlen = 'h%0x and Slave awlen = 'h%0x",axi5_master_tx_h1.awlen,axi5_slave_tx_h1.awlen), UVM_HIGH);             
    byte_data_cmp_verified_awlen_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_awlen from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_awlen_NOT_MATCHED", $sformatf("Master awlen = 'h%0x and Slave awlen = 'h%0x",axi5_master_tx_h1.awlen,axi5_slave_tx_h1.awlen), UVM_HIGH);             
    byte_data_cmp_failed_awlen_count++;
  end

  if(axi5_master_tx_h1.awsize == axi5_slave_tx_h1.awsize)begin
    `uvm_info(get_type_name(),$sformatf("axi5_awsize from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_awsize_MATCHED", $sformatf("Master awsize = 'h%0x and Slave awsize = 'h%0x",axi5_master_tx_h1.awsize,axi5_slave_tx_h1.awsize), UVM_HIGH);             
    byte_data_cmp_verified_awsize_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_awsize from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_awsize_NOT_MATCHED", $sformatf("Master awsize = 'h%0x and Slave awsize = 'h%0x",axi5_master_tx_h1.awsize,axi5_slave_tx_h1.awsize), UVM_HIGH);             
    byte_data_cmp_failed_awsize_count++;
  end

  if(axi5_master_tx_h1.awburst == axi5_slave_tx_h1.awburst)begin
    `uvm_info(get_type_name(),$sformatf("axi5_awburst from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_awburst_MATCHED", $sformatf("Master awburst = 'h%0x and Slave awburst = 'h%0x",axi5_master_tx_h1.awburst,axi5_slave_tx_h1.awburst), UVM_HIGH);             
    byte_data_cmp_verified_awburst_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_awburst from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_awburst_NOT_MATCHED", $sformatf("Master awburst = 'h%0x and Slave awburst = 'h%0x",axi5_master_tx_h1.awburst,axi5_slave_tx_h1.awburst), UVM_HIGH);             
    byte_data_cmp_failed_awburst_count++;
  end

  if(axi5_master_tx_h1.awlock == axi5_slave_tx_h1.awlock)begin
    `uvm_info(get_type_name(),$sformatf("axi5_awlock from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_awlock_MATCHED", $sformatf("Master awlock = 'h%0x and Slave awlock = 'h%0x",axi5_master_tx_h1.awlock,axi5_slave_tx_h1.awlock), UVM_HIGH);             
    byte_data_cmp_verified_awlock_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_awlock from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_awlock_NOT_MATCHED", $sformatf("Master awlock = 'h%0x and Slave awlock = 'h%0x",axi5_master_tx_h1.awlock,axi5_slave_tx_h1.awlock), UVM_HIGH);             
    byte_data_cmp_failed_awlock_count++;
  end

  if(axi5_master_tx_h1.awcache == axi5_slave_tx_h1.awcache)begin
    `uvm_info(get_type_name(),$sformatf("axi5_awcache from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_awcache_MATCHED", $sformatf("Master awcache = 'h%0x and Slave awcache = 'h%0x",axi5_master_tx_h1.awcache,axi5_slave_tx_h1.awcache), UVM_HIGH);             
    byte_data_cmp_verified_awcache_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_awcache from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_awcache_NOT_MATCHED", $sformatf("Master awcache = 'h%0x and Slave awcache = 'h%0x",axi5_master_tx_h1.awcache,axi5_slave_tx_h1.awcache), UVM_HIGH);             
    byte_data_cmp_failed_awcache_count++;
  end

  if(axi5_master_tx_h1.awprot == axi5_slave_tx_h1.awprot)begin
    `uvm_info(get_type_name(),$sformatf("axi5_awprot from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_awprot_MATCHED", $sformatf("Master awprot = 'h%0x and Slave awprot = 'h%0x",axi5_master_tx_h1.awprot,axi5_slave_tx_h1.awprot), UVM_HIGH);             
    byte_data_cmp_verified_awprot_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_awprot from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_awprot_NOT_MATCHED", $sformatf("Master awprot = 'h%0x and Slave awprot = 'h%0x",axi5_master_tx_h1.awprot,axi5_slave_tx_h1.awprot), UVM_HIGH);
    byte_data_cmp_failed_awprot_count++;
  end

endtask : axi5_write_address_comparision

//--------------------------------------------------------------------------------------------
// Task : axi5_write_data_comparision
// Used to compare the received master and slave write data
// Parameter :
//  axi5_master_tx_h2 - axi5_master_tx
//  axi5_slave_tx_h2  - axi5_slave_tx
//--------------------------------------------------------------------------------------------
task axi5_scoreboard::axi5_write_data_comparision(input axi5_master_tx axi5_master_tx_h2,input axi5_slave_tx axi5_slave_tx_h2);

  axi5_write_address_comparision(axi5_master_tx_h2,axi5_slave_tx_h2);

  if(axi5_master_tx_h2.wdata == axi5_slave_tx_h2.wdata)begin
    `uvm_info(get_type_name(),$sformatf("axi5_wdata from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_wdata_MATCHED", $sformatf("Master wdata = %0p and Slave wdata = %0p",axi5_master_tx_h2.wdata,axi5_slave_tx_h2.wdata), UVM_HIGH);             
    byte_data_cmp_verified_wdata_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_wdata from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_wdata_NOT_MATCHED", $sformatf("Master wdata = %0p and Slave wdata = %0p",axi5_master_tx_h2.wdata,axi5_slave_tx_h2.wdata), UVM_HIGH);             
  end

  if(axi5_master_tx_h2.wstrb == axi5_slave_tx_h2.wstrb)begin
    `uvm_info(get_type_name(),$sformatf("axi5_wstrb from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_wstrb_MATCHED", $sformatf("Master wstrb = %0p and Slave wstrb = %0p",axi5_master_tx_h2.wstrb,axi5_slave_tx_h2.wstrb), UVM_HIGH);             
    byte_data_cmp_verified_wstrb_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_wstrb from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_wstrb_NOT_MATCHED", $sformatf("Master wstrb = %0p and Slave wstrb = %0p",axi5_master_tx_h2.wstrb,axi5_slave_tx_h2.wstrb), UVM_HIGH);             
  end

  if(axi5_master_tx_h2.wuser == axi5_slave_tx_h2.wuser)begin
    `uvm_info(get_type_name(),$sformatf("axi5_wuser from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_wuser_MATCHED", $sformatf("Master wuser = 'h%0x and Slave wuser = 'h%0x",axi5_master_tx_h2.wuser,axi5_slave_tx_h2.wuser), UVM_HIGH);             
    byte_data_cmp_verified_wuser_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_wuser from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_wuser_NOT_MATCHED", $sformatf("Master wuser = 'h%0x and Slave wuser = 'h%0x",axi5_master_tx_h2.wuser,axi5_slave_tx_h2.wuser), UVM_HIGH);             
  end

endtask : axi5_write_data_comparision

//--------------------------------------------------------------------------------------------
// Task : axi5_write_response_comparision
// Used to compare the received master and slave write response
// Parameter :
//  axi5_master_tx_h3 - axi5_master_tx
//  axi5_slave_tx_h3  - axi5_slave_tx
//--------------------------------------------------------------------------------------------
task axi5_scoreboard::axi5_write_response_comparision(input axi5_master_tx axi5_master_tx_h3,input axi5_slave_tx axi5_slave_tx_h3);

  axi5_write_data_comparision(axi5_master_tx_h3,axi5_slave_tx_h3);

  if(axi5_master_tx_h3.bid == axi5_slave_tx_h3.bid)begin
    `uvm_info(get_type_name(),$sformatf("axi5_bid from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_bid_MATCHED", $sformatf("Master bid = %0p and Slave bid = %0p",axi5_master_tx_h3.bid,axi5_slave_tx_h3.bid), UVM_HIGH);             
    byte_data_cmp_verified_bid_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_bid from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_bid_NOT_MATCHED", $sformatf("Master bid = %0p and Slave bid = %0p",axi5_master_tx_h3.bid,axi5_slave_tx_h3.bid), UVM_HIGH);             
  end

  if(axi5_master_tx_h3.bresp == axi5_slave_tx_h3.bresp)begin
    `uvm_info(get_type_name(),$sformatf("axi5_bresp from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_bresp_MATCHED", $sformatf("Master bresp = %0p and Slave bresp = %0p",axi5_master_tx_h3.bresp,axi5_slave_tx_h3.bresp), UVM_HIGH);             
    byte_data_cmp_verified_bresp_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_bresp from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_bresp_NOT_MATCHED", $sformatf("Master bresp = %0p and Slave bresp = %0p",axi5_master_tx_h3.bresp,axi5_slave_tx_h3.bresp), UVM_HIGH);             
  end

  if(axi5_master_tx_h3.buser == axi5_slave_tx_h3.buser)begin
    `uvm_info(get_type_name(),$sformatf("axi5_buser from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_buser_MATCHED", $sformatf("Master buser = 'h%0x and Slave buser = 'h%0x",axi5_master_tx_h3.buser,axi5_slave_tx_h3.buser), UVM_HIGH);             
    byte_data_cmp_verified_buser_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_buser from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_buser_NOT_MATCHED", $sformatf("Master buser = 'h%0x and Slave buser = 'h%0x",axi5_master_tx_h3.buser,axi5_slave_tx_h3.buser), UVM_HIGH);             
  end
endtask : axi5_write_response_comparision

//--------------------------------------------------------------------------------------------
// Task : axi5_read_address_comparision
// Used to compare the received master and slave read address
// Parameter :
//  axi5_master_tx_h4 - axi5_master_tx
//  axi5_slave_tx_h4  - axi5_slave_tx
//--------------------------------------------------------------------------------------------
task axi5_scoreboard::axi5_read_address_comparision(input axi5_master_tx axi5_master_tx_h4,input axi5_slave_tx axi5_slave_tx_h4);

  
  if(axi5_master_tx_h4.arid == axi5_slave_tx_h4.arid)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arid from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arID_MATCHED", $sformatf("Master arID = 'h%0x and Slave arID = 'h%0x",axi5_master_tx_h4.arid,axi5_slave_tx_h4.arid), UVM_HIGH);             
    byte_data_cmp_verified_arid_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arid from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arID_NOT_MATCHED", $sformatf("Master arID = 'h%0x and Slave arID = 'h%0x",axi5_master_tx_h4.arid,axi5_slave_tx_h4.arid), UVM_HIGH);             
  end
  
  if(axi5_master_tx_h4.araddr == axi5_slave_tx_h4.araddr)begin
    `uvm_info(get_type_name(),$sformatf("axi5_araddr from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arADDR_MATCHED", $sformatf("Master arADDR = 'h%0x and Slave arADDR = 'h%0x",axi5_master_tx_h4.araddr,axi5_slave_tx_h4.araddr), UVM_HIGH);             
    byte_data_cmp_verified_araddr_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_araddr from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arADDR_NOT_MATCHED", $sformatf("Master arADDR = 'h%0x and Slave arADDR = 'h%0x",axi5_master_tx_h4.araddr,axi5_slave_tx_h4.araddr), UVM_HIGH);             
  end

  if(axi5_master_tx_h4.arlen == axi5_slave_tx_h4.arlen)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arlen from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arlen_MATCHED", $sformatf("Master arlen = 'h%0x and Slave arlen = 'h%0x",axi5_master_tx_h4.arlen,axi5_slave_tx_h4.arlen), UVM_HIGH);             
    byte_data_cmp_verified_arlen_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arlen from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arlen_NOT_MATCHED", $sformatf("Master arlen = 'h%0x and Slave arlen = 'h%0x",axi5_master_tx_h4.arlen,axi5_slave_tx_h4.arlen), UVM_HIGH);             
  end

  if(axi5_master_tx_h4.arsize == axi5_slave_tx_h4.arsize)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arsize from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arsize_MATCHED", $sformatf("Master arsize = 'h%0x and Slave arsize = 'h%0x",axi5_master_tx_h4.arsize,axi5_slave_tx_h4.arsize), UVM_HIGH);             
    byte_data_cmp_verified_arsize_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arsize from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arsize_NOT_MATCHED", $sformatf("Master arsize = 'h%0x and Slave arsize = 'h%0x",axi5_master_tx_h4.arsize,axi5_slave_tx_h4.arsize), UVM_HIGH);             
  end

  if(axi5_master_tx_h4.arburst == axi5_slave_tx_h4.arburst)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arburst from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arburst_MATCHED", $sformatf("Master arburst = 'h%0x and Slave arburst = 'h%0x",axi5_master_tx_h4.arburst,axi5_slave_tx_h4.arburst), UVM_HIGH);             
    byte_data_cmp_verified_arburst_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arburst from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arburst_NOT_MATCHED", $sformatf("Master arburst = 'h%0x and Slave arburst = 'h%0x",axi5_master_tx_h4.arburst,axi5_slave_tx_h4.arburst), UVM_HIGH);             
  end

  if(axi5_master_tx_h4.arlock == axi5_slave_tx_h4.arlock)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arlock from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arlock_MATCHED", $sformatf("Master arlock = 'h%0x and Slave arlock = 'h%0x",axi5_master_tx_h4.arlock,axi5_slave_tx_h4.arlock), UVM_HIGH);             
    byte_data_cmp_verified_arlock_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arlock from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arlock_NOT_MATCHED", $sformatf("Master arlock = 'h%0x and Slave arlock = 'h%0x",axi5_master_tx_h4.arlock,axi5_slave_tx_h4.arlock), UVM_HIGH);             
  end

  if(axi5_master_tx_h4.arcache == axi5_slave_tx_h4.arcache)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arcache from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arcache_MATCHED", $sformatf("Master arcache = 'h%0x and Slave arcache = 'h%0x",axi5_master_tx_h4.arcache,axi5_slave_tx_h4.arcache), UVM_HIGH);             
    byte_data_cmp_verified_arcache_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arcache from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arcache_NOT_MATCHED", $sformatf("Master arcache = 'h%0x and Slave arcache = 'h%0x",axi5_master_tx_h4.arcache,axi5_slave_tx_h4.arcache), UVM_HIGH);             
  end

  if(axi5_master_tx_h4.arprot == axi5_slave_tx_h4.arprot)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arprot from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arprot_MATCHED", $sformatf("Master arprot = 'h%0x and Slave arprot = 'h%0x",axi5_master_tx_h4.arprot,axi5_slave_tx_h4.arprot), UVM_HIGH);             
    byte_data_cmp_verified_arprot_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arprot from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arprot_NOT_MATCHED", $sformatf("Master arprot = 'h%0x and Slave arprot = 'h%0x",axi5_master_tx_h4.arprot,axi5_slave_tx_h4.arprot), UVM_HIGH);             
  end

  if(axi5_master_tx_h4.arregion == axi5_slave_tx_h4.arregion)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arregion from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arregion_MATCHED", $sformatf("Master arregion = 'h%0x and Slave arregion = 'h%0x",axi5_master_tx_h4.arregion,axi5_slave_tx_h4.arregion), UVM_HIGH);             
    byte_data_cmp_verified_arregion_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arregion from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arregion_NOT_MATCHED", $sformatf("Master arregion = 'h%0x and Slave arregion = 'h%0x",axi5_master_tx_h4.arregion,axi5_slave_tx_h4.arregion), UVM_HIGH);             
  end

  if(axi5_master_tx_h4.arqos == axi5_slave_tx_h4.arqos)begin
    `uvm_info(get_type_name(),$sformatf("axi5_arqos from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_arqos_MATCHED", $sformatf("Master arqos = 'h%0x and Slave arqos = 'h%0x",axi5_master_tx_h4.arqos,axi5_slave_tx_h4.arqos), UVM_HIGH);             
    byte_data_cmp_verified_arqos_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_arqos from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_arqos_NOT_MATCHED", $sformatf("Master arqos = 'h%0x and Slave arqos = 'h%0x",axi5_master_tx_h4.arqos,axi5_slave_tx_h4.arqos), UVM_HIGH);             
  end
endtask : axi5_read_address_comparision

//--------------------------------------------------------------------------------------------
// Task : axi5_read_data_comparision
// Used to compare the received master and slave read data
// Parameter :
//  axi5_master_tx_h5 - axi5_master_tx
//  axi5_slave_tx_h5  - axi5_slave_tx
//--------------------------------------------------------------------------------------------
task axi5_scoreboard::axi5_read_data_comparision(input axi5_master_tx axi5_master_tx_h5,input axi5_slave_tx axi5_slave_tx_h5);

  axi5_read_address_comparision(axi5_master_tx_h5,axi5_slave_tx_h5);
  
  if(axi5_master_tx_h5.rid == axi5_slave_tx_h5.rid)begin
    `uvm_info(get_type_name(),$sformatf("axi5_rid from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_rid_MATCHED", $sformatf("Master rid = %0p and Slave rid = %0p",axi5_master_tx_h5.rid,axi5_slave_tx_h5.rid), UVM_HIGH);             
    byte_data_cmp_verified_rid_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_rid from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_rid_NOT_MATCHED", $sformatf("Master rid = %0p and Slave rid = %0p",axi5_master_tx_h5.rid,axi5_slave_tx_h5.rid), UVM_HIGH);             
  end

  if(axi5_master_tx_h5.rdata == axi5_slave_tx_h5.rdata)begin
    `uvm_info(get_type_name(),$sformatf("axi5_rdata from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_rdata_MATCHED", $sformatf("Master rdata = %0p and Slave rdata = %0p",axi5_master_tx_h5.rdata,axi5_slave_tx_h5.rdata), UVM_HIGH);             
    byte_data_cmp_verified_rdata_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_rdata from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_rdata_NOT_MATCHED", $sformatf("Master rdata = %0p and Slave rdata = %0p",axi5_master_tx_h5.rdata,axi5_slave_tx_h5.rdata), UVM_HIGH);             
  end

  if(axi5_master_tx_h5.rresp == axi5_slave_tx_h5.rresp)begin
    `uvm_info(get_type_name(),$sformatf("axi5_rresp from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_rresp_MATCHED", $sformatf("Master rresp = %0p and Slave rresp = %0p",axi5_master_tx_h5.rresp,axi5_slave_tx_h5.rresp), UVM_HIGH);             
    byte_data_cmp_verified_rresp_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_rresp from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_rresp_NOT_MATCHED", $sformatf("Master rresp = %0p and Slave rresp = %0p",axi5_master_tx_h5.rresp,axi5_slave_tx_h5.rresp), UVM_HIGH);             
  end

  if(axi5_master_tx_h5.ruser == axi5_slave_tx_h5.ruser)begin
    `uvm_info(get_type_name(),$sformatf("axi5_ruser from master and slave is equal"),UVM_HIGH);
    `uvm_info("SB_ruser_MATCHED", $sformatf("Master ruser = %0p and Slave ruser = %0p",axi5_master_tx_h5.ruser,axi5_slave_tx_h5.ruser), UVM_HIGH);             
    byte_data_cmp_verified_ruser_count++;
  end
  else begin
    `uvm_info(get_type_name(),$sformatf("axi5_ruser from master and slave is  not equal"),UVM_HIGH);
    `uvm_info("SB_ruser_NOT_MATCHED", $sformatf("Master ruser = %0p and Slave ruser = %0p",axi5_master_tx_h5.ruser,axi5_slave_tx_h5.ruser), UVM_HIGH);             
  end

endtask : axi5_read_data_comparision
