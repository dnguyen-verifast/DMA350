`ifndef AXI5_SLAVE_COVERAGE_INCLUDED_
`define AXI5_SLAVE_COVERAGE_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: slave_coverage
// slave_coverage determines the how much code is covered for better functionality of the TB.
//--------------------------------------------------------------------------------------------
class axi5_slave_coverage extends uvm_subscriber#(axi5_slave_tx);
  `uvm_component_utils(axi5_slave_coverage)
  ...
  //-------------------------------------------------------
  // Covergroup: axi5_slave_covergroup
  // Covergroup consists of the various coverpoints based on
  // no. of the variables used to improve the coverage.
  //-------------------------------------------------------
  covergroup axi5_slave_covergroup with function sample (axi5_slave_agent_config cfg, axi5_slave_tx packet);
  ...
  endgroup: axi5_slave_covergroup

  //-------------------------------------------------------
  // Externally defined Tasks and Functions
  //-------------------------------------------------------
  extern function new(string name = "axi5_slave_coverage", uvm_component parent = null);
  extern virtual function void write(axi5_slave_tx t);
  extern virtual function void report_phase(uvm_phase phase);
endclass : axi5_slave_coverage

//--------------------------------------------------------------------------------------------
// Construct: new
//
// Parameters:
//  name - axi5_slave_coverage
//  parent - parent under which this component is created
//--------------------------------------------------------------------------------------------
function axi5_slave_coverage::new(string name = "axi5_slave_coverage",uvm_component parent = null);
  super.new(name, parent);
  axi5_slave_covergroup =new();
endfunction : new
...
// sampling is done
//--------------------------------------------------------------------------------------------
function void axi5_slave_coverage::write(axi5_slave_tx t);
 `uvm_info(get_type_name(),$sformatf("Before calling SAMPLE METHOD"),UVM_HIGH);

  axi5_slave_covergroup.sample(axi5_slave_agent_cfg_h,t);
...
//--------------------------------------------------------------------------------------------
function void axi5_slave_coverage::report_phase(uvm_phase phase);
  `uvm_info(get_type_name(),$sformatf("AXI5 Slave Agent Coverage = %0.2f %%", axi5_slave_covergroup.get_coverage()), UVM_NONE);
