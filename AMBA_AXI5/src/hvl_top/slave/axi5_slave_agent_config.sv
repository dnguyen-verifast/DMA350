`ifndef AXI5_SLAVE_AGENT_CONFIG_INCLUDED_
`define AXI5_SLAVE_AGENT_CONFIG_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: axi5_slave_agent_config
// Used as the configuration class for axi5_slave agent and it's components
//--------------------------------------------------------------------------------------------
class axi5_slave_agent_config extends uvm_object;
  `uvm_object_utils(axi5_slave_agent_config)
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi5_slave_agent_config");
  extern function void do_print(uvm_printer printer);
  extern function int get_minimum_transactions();
endclass : axi5_slave_agent_config
...
//--------------------------------------------------------------------------------------------
function axi5_slave_agent_config::new(string name = "axi5_slave_agent_config");
  super.new(name); 
endfunction : new

function int axi5_slave_agent_config::get_minimum_transactions();
...
//  printer - uvm_printer
//--------------------------------------------------------------------------------------------
function void axi5_slave_agent_config::do_print(uvm_printer printer);
