`ifndef AXI5_MASTER_MONITOR_BFM_INCLUDED_
`define AXI5_MASTER_MONITOR_BFM_INCLUDED_

//--------------------------------------------------------------------------------------------
//Interface : axi5_master_monitor_bfm
//Used as the HDL monitor for axi5
//It connects with the HVL monitor_proxy for driving the stimulus
//--------------------------------------------------------------------------------------------
import axi5_globals_pkg::*;

interface axi5_master_monitor_bfm(input bit aclk, input bit aresetn,
  ...
  //-------------------------------------------------------
  // Importing axi5 Global Package master package
  //-------------------------------------------------------
  import axi5_master_pkg::axi5_master_monitor_proxy;
 
  //Variable : axi5_master_monitor_proxy_h
  ...
  //-------------------------------------------------------
  // Task: axi5_write_address_sampling
  // Used for sample the write address channel signals
  //-------------------------------------------------------
  task axi5_write_address_sampling(output axi5_write_transfer_char_s req ,input axi5_transfer_cfg_s cfg);
  ...
  //-------------------------------------------------------
  // Task: axi5_write_data_sampling
  // Used for sample the write data channel signals
  //-------------------------------------------------------
  task axi5_write_data_sampling(output axi5_write_transfer_char_s req ,input axi5_transfer_cfg_s cfg);
  ...
  //-------------------------------------------------------
  task axi5_read_data_sampling(output axi5_read_transfer_char_s req ,input axi5_transfer_cfg_s cfg);
    static reg[7:0] i = 0;
    forever begin
      // Wait for valid and ready to be high
      do begin
  ...
  endtask
endinterface : axi5_master_monitor_bfm
